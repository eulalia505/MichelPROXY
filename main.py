        ...
        if '/start' in msgText:
            ...
            bot.editMessageText(message,start_msg)
             ...
             if loged:
                ...
                if len(List2)>0:
                    message = bot.sendMessage(update.message.chat.id,'🌐Conectando...')
                    for item in List2:
            ...
            index = int(str(msgText).split('_')[1]) - 1
